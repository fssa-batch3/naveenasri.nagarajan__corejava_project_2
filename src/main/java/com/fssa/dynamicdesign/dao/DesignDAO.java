...
public class DesignDAO {
	...
	public boolean updateDesign(long uniqueId, Design updatedDesign) throws DAOException {
	    ...
	    try (Connection connection = ConnectionUtil.getConnection();
	        ...
	        double pricePerSqFt = resultSet.getDouble("price_per_sqft");
	        int squareFeet = resultSet.getInt("square_feet");
	        String category = resultSet.getString("category");
	        String floorPlan = resultSet.getString("floor_plan");
	        int timeRequired = resultSet.getInt("time_required");
